...
- **Identity assets** — favicon, OG image, and whether jass's photo appears on the site at all (`avatar.webp` is committed; a full-frame `photo.webp` exists untracked on main). The socials half of this is settled: **they render as text, and all ten SVGs are deleted.**
